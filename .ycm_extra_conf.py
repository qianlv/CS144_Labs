...
# DIR_OF_THIRD_PARTY = os.path.join( DIR_OF_THIS_SCRIPT, '/.vim/bundle/YouCompleteMe/third_party' )
DIR_OF_THIRD_PARTY = '/home/qianlv/.vim/bundle/YouCompleteMe/third_party'
...
'c++',
'-I', './',
'-isystem', 'cpp/pybind11', '-isystem', 'cpp/BoostParts',
...
'-isystem', '/usr/include',
'-isystem', '/usr/src/linux-headers-5.4.0-29/include/',
'-isystem', '/usr/src/linux-headers-5.4.0-29-generic/arch/x86/include/',
]
